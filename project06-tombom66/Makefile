...
CLANGTDY_CHKS := *,-google-build-using-namespace,-fuchsia-default-arguments,-llvm-header-guard,-cppcoreguidelines-pro-bounds-constant-array-index,-performance-unnecessary-value-param,-cppcoreguidelines-pro-bounds-array-to-pointer-decay,-hicpp-no-array-decay,-cppcoreguidelines-pro-bounds-pointer-arithmetic,-google-runtime-references,-google-explicit-constructor,-cppcoreguidelines-special-member-functions,-modernize-pass-by-value,-hicpp-explicit-conversions,-hicpp-special-member-functions,-cppcoreguidelines-owning-memory,-hicpp-use-auto,-modernize-use-auto
