# Summation
Use a loop to add a number a given number n times.

*Note: This problem can be solved by using multiplication. However, the goal is to practice using loops so make sure you use loops to get full points.*

Sample Input/Output
```
Please enter a number: 5
How many times to be added: 10
The summation is 50
```
```
Please enter a number: 3
How many times to be added: 30
The summation is 90
```
```
Please enter a number: 50
How many times to be added: 20
The summation is 1000
```
